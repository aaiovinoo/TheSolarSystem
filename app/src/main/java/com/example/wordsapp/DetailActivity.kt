...
class DetailActivity : AppCompatActivity() {
    companion object{
        // creating letter constant that belongs to Detail Activity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val planetId = intent?.extras?.getString(PLANET).toString()

        val recyclerView = binding.recyclerView
        recyclerView.layoutManager = LinearLayoutManager(this)
        recyclerView.adapter = FactAdapter(planetId, this)
        ...
        title = getString(R.string.detail_prefix) + " " + planetId
    }
}